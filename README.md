...
> Answer: With client-side routing you minimze the number HTTP requests the browser has to make. This is a benefit because every time a user requests something they do not have to wait for a page reload to happen. This improves the user experience as well as the performance for the web application.
...
- [x]  Create a new Branch on the clone: `git checkout -b <fistName-lastName>`.
